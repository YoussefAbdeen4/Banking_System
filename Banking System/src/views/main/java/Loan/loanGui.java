 ...
 */
package views.main.java.Loan;

import Controllers.command.CreateLoanCommand;
...
public class loanGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setToolTipText("Years ");

        jTextField2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N

        jComboBox1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Car", "Personal", "Home " }));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int years = Integer.parseInt(jTextField2.getText());
        double amount = Double.parseDouble(jTextField3.getText());
        String type = (String) jComboBox1.getSelectedItem();
        CreateLoanCommand command = new CreateLoanCommand(id,  amount,  years, type.toLowerCase().trim());
        command.execute();
        clearForm();
