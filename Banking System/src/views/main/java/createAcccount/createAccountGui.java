 ...
 */
package views.main.java.createAcccount;

import Controllers.command.CreateAccountCommand;
...
public class createAccountGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Loan", "Checking", "Saving " }));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        //JOptionPane.showMessageDialog(null,type,"Success", JOptionPane.INFORMATION_MESSAGE);
        CreateAccountCommand command = new CreateAccountCommand( ssn, balance, type);
        command.execute();
        clearForm();
